...
@section('title', 'Listagem dos Pregões')

@section('content')

    <h1 class="text-center text-3xl uppercase font-black my-4">Listagem dos Pregões</h1>

    <div class="grid">
        <a href="{{ route('posts.create') }}" class="my-4 uppercase px-8 py-2 rounded bg-green-600 text-blue-50 max-w-max shadow-sm hover:shadow-lg">Criar Pregão</a>
    </div>
    @if (session('message'))
