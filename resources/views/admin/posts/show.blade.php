...
@section('title', 'Detalhes do Pregões')

@section('content')
    <h1 class="text-center text-3xl uppercase font-black my-4">Detalhes do Pregão {{ $post->title }}</h1>
    ...
    <div class="w-11/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12 mx-auto">
        ...
        <form action="{{ route('posts.destroy', $post->id) }}" method="post">
            ...
            <button type="submit"
                ...
                Deletar o Pregão: {{ $post->title }}</button>
        </form>
    </div>
@endsection
